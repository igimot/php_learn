...
<p>21. Нарисуйте пирамиду, как показано на рисунке, только у вашей пирамиды должно быть 9
    ...
    4444<br>
    55555</p>
<p>22. Нарисуйте пирамиду, как показано на рисунке, воспользовавшись циклом for или while.<a href="arrays_loops_tasks/22.php"> решение</a><br><br>
    xx<br>
    xxxx<br>
    xxxxxx<br>
    xxxxxxxx<br>
...
<p>23. Вам нужно разработать программу, которая считала бы сумму цифр числа введенного
    ...
    2, 3, т. е. 6.<a href="arrays_loops_tasks/23/index.php"> решение</a></p>
...
<p>24. Вам нужно разработать программу, которая считала бы количество вхождений
    ...
    442158755745 встречается 4 раза.<a href="arrays_loops_tasks/24/index.php"> решение</a></p>
<p>25. Ваше задание создать массив, наполнить это случайными значениями (функция rand),
    найти максимальное и минимальное значение и поменять их местами.<a href="arrays_loops_tasks/25/index.php"> решение</a></p>
...
<<<<<<< HEAD
    индекс.<a href="arrays_loops_tasks/26.php"> решение</a></p>
<p>27. Создать генератор случайных таблиц. Есть переменные: $row - кол-во строк в таблице, $cols - кол-во столбцов в таблице.
    ...
    выбранные случайным образом из массива $colors. В каждой ячейке должно находиться случайное число. <a href="arrays_loops_tasks/27/index.php"> решение</a> <br><br>
...
<p>28. Вывести таблицу умножения с помощью двух циклов for.<a href="arrays_loops_tasks/13.php"> решение</a></p>
